...
(function(jigLib){
	...
	RigidBody.prototype.pitch=function(rot){
		this.setOrientation(JMatrix3D.getAppendMatrix3D(this.get_currentState().get_orientation(), JMatrix3D.getRotationMatrixAxis(rot, Vector3DUtil.X_AXIS)));
	};
	...
	RigidBody.prototype.yaw=function(rot){
		this.setOrientation(JMatrix3D.getAppendMatrix3D(this.get_currentState().get_orientation(), JMatrix3D.getRotationMatrixAxis(rot, Vector3DUtil.Y_AXIS)));
	};
	...
	RigidBody.prototype.roll=function(rot){
		this.setOrientation(JMatrix3D.getAppendMatrix3D(this.get_currentState().get_orientation(), JMatrix3D.getRotationMatrixAxis(rot, Vector3DUtil.Z_AXIS)));
	};
